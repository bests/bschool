...
<head>
 ...
 <link type="text/css" rel="stylesheet" href="cssmain/modal.css" />
    ...
    <link type="text/css" rel="stylesheet" href="cssmain/navobile.css" /> 
         ...
         <link type="text/css" rel="stylesheet" href="flexslider/s.css" />  
...
<div class="row">
    ...
    <div id="carousel" class="flexslider">
          <ul class="slides">
            <li>
                <div class="col-xs-6 col-sm-3 left-text fetwidth bluegreenbg" data-info="1">
              ...
              <div class="media-body">
                ...
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. 
                      ...
                      <li><div class="col-xs-6 col-sm-3 left-text fetwidth bluegreenbg" data-info="1">
 ...
 <div id="slider" class="flexslider">
          <ul class="slides">
            <li>
  	    	    <div class="title"> <i class="icon-globe icons"></i> <h2>Multipurpose</h2><hr> <p class="medium">We are a creative agency located in <strong>Brooklyn New York.</strong> We’ve won a ton of awards
...
<script src="js/vendor/s2.js"></script> 
  ...
  <script type="text/javascript">
    ...
    manualControls: ".flexslider li a",
