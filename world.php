...
<div class="bs-docs-example paddingbottom">
 <h3>2. Understand the benefits</h3>
            <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="#one" data-toggle="tab">Our website</a></li>
           
              <li class=""><a href="#three" data-toggle="tab">Marketing reports</a></li>
              <li class=""><a href="#three" data-toggle="tab">Technology</a></li>
              <li class=""><a href="#three" data-toggle="tab">Marketing Campaigns</a></li>
             <li class=""><a href="#three" data-toggle="tab">Social Media</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
...
Modernizr.load({
  ...
  nope: 'http://localhost/gitxamp/css/clouds.css'
});
